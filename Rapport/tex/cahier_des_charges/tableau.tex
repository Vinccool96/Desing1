...
\begin{table}[htp]
	...
	\begin{tabular}{|l|c|c|c|c|}
		...
		\ref{s:cdc_sec_alar} Alarmes & 5 & Équation \ref{eq:cdc_sec_alar} & & \\
		\ref{s:cdc_sec_protaccdist} Protection de l’accès à distance & 4 & Équation \ref{eq:cdc_sec_protaccdist} & & \\
