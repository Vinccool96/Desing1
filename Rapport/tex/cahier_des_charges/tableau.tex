...
\begin{table}[htp]
	...
	\begin{tabular}{|l|c|c|c|c|}
		...
		\ref{s:cdc_pdd_donnees_enre} Données enregistrées & 5 &Tableau \ref{t:tab_pdd_donnees_enr} & & \\		
		\hline
		\hline
		...
		\ref{s:cdc_stock_duree} Durée de conservation des données & 3 & Tableau \ref{t:cdc_stock_duree} & & \\
