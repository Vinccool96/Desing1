...
\TitreProjet{Projet Fish \& Chips: Système autonome fixe pour le comptage et
...
\DateRemise{21 mars 2019}                           % Date de remis
...
\HistoriqueVersions{
	...
	2.0 & 21 mars 2019 & Conceptualisation et analyse de faisabilité \\\hline
}
...
\begin{document}
	...
	% Définitions
	\input{def/commandes.tex}
	
	%   Chapitres
	%
	\input{tex/introduction.tex}
	\input{tex/description.tex}
	\input{tex/besoins_et_objectifs.tex}
	\input{tex/cahier_des_charges.tex}
	\input{tex/conceptualisation_analyse_faisabilite.tex}
	\input{tex/bibliographie.tex}
	
	%   Annexes
	\appendix
	\input{tex/list_sig_acr}
